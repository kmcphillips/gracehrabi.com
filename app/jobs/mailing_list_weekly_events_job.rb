# module Jobs
  class MailingListWeeklyEventsJob
      ...
      if @events.any?
        ...
        @contacts.each do |contact|
          ...
          begin
            ...
            Rails.logger.error("Jobs::MailingListWeeklyEventsJob -- Error delivering to #{ contact }: #{ e.message }")
          end
        end
      else
    ...
    def log(message)
      Rails.logger.info("Jobs::MailingListWeeklyEventsJob -- #{ message }")
    end
